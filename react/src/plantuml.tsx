...
export const plantuml = (() => {
    ...
    const renderPng = (
        ...
        return new Promise<Partial<IRenderPngResult>>(resolve => {
            ...
            cjCall(
                ...
                if (obj?.status == 'ok') {
                    cjFileBlob(`result-${resultFileSuffix}.png`).then(
                        (blob: Blob) => {
    ...
    const _preloadPlantumlFiles = async (urlBasePathForFiles: string) => {
    ...
    return { initialize, renderSvg, renderPng }
})()
