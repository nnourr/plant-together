...
describe('plantuml', () => {
    ...
    describe('initialize', () => {
        it('should initialize PlantUML with default path', async () => {
            ...
            expect(globalThis.fetch).toHaveBeenCalledWith(
                expect.stringContaining('plantuml-core.jar.js'),
            )
            expect(globalThis.fetch).toHaveBeenCalledWith(
                expect.stringContaining('plantuml-core.jar'),
            )
        })
        ...
        it('should initialize PlantUML with custom path', async () => {
            ...
            // Verify fetch calls
            expect(globalThis.fetch).toHaveBeenCalledWith(
                expect.stringContaining('/custom/path/plantuml-core.jar.js'),
            )
            expect(globalThis.fetch).toHaveBeenCalledWith(
                expect.stringContaining('/custom/path/plantuml-core.jar'),
            )
        })
    })
    ...
    describe('renderPng', () => {
        ...
        it('should handle successful PNG rendering', async () => {
            ...
            globalThis.cjCall.mockResolvedValue(
